...
const SEARCH_INDEX = [
    ...
    { title: 'Neo X Integration', desc: 'Route status, wNEO/wGAS reserves, rewards reads, DEX pairs, and agent-compute gates', url: 'rpc-reference.html#neo-x-route-rewards', category: 'Neo' },
    ...
    { title: 'Neo Agent Compute', desc: 'Opt-in agent spending caps, PQ action hashes, and COMPUTE policy helpers', url: 'contract-reference.html#compute-market', category: 'Neo' },
