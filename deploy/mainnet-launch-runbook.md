...
`v0.5.267`; keep `v0.5.265` as the signed restart-safe anchor and immediate
...
- Do not deploy a release that changes consensus rules with a mixed-version
  ...
  until `v0.5.267` is signed, fully qualified, deployed, and explicitly
...
```bash
export LICHEN_RELEASE_TAG=v0.5.267
