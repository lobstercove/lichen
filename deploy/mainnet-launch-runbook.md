...
`v0.5.273`; keep `v0.5.265` as the signed restart-safe anchor and immediate
...
until `v0.5.273` is signed, fully qualified, deployed, and explicitly
...
```bash
export LICHEN_RELEASE_TAG=v0.5.273
