...
if [ "$RESTART" = true ]; then
    ...
    echo "   cp ./seeds.json ./data/state-8000/seeds.json && ./target/release/lichen-validator --p2p-port 8000 --rpc-port 8899 --db-path \$PWD/data/state-8000"
    echo "   cp ./seeds.json ./data/state-8001/seeds.json && ./target/release/lichen-validator --p2p-port 8001 --rpc-port 8901 --db-path \$PWD/data/state-8001"
    echo "   cp ./seeds.json ./data/state-8002/seeds.json && ./target/release/lichen-validator --p2p-port 8002 --rpc-port 8903 --db-path \$PWD/data/state-8002"
    echo ""
    echo "   # Option C: Dev mode (multi-validator on one machine, bypasses fingerprint)"
    echo "   cp ./seeds.json ./data/state-8000/seeds.json && ./target/release/lichen-validator --dev-mode --p2p-port 8000 --rpc-port 8899 --db-path \$PWD/data/state-8000"
    echo "   cp ./seeds.json ./data/state-8001/seeds.json && ./target/release/lichen-validator --dev-mode --p2p-port 8001 --rpc-port 8901 --db-path \$PWD/data/state-8001"
    echo "   cp ./seeds.json ./data/state-8002/seeds.json && ./target/release/lichen-validator --dev-mode --p2p-port 8002 --rpc-port 8903 --db-path \$PWD/data/state-8002"
    echo ""
