    ...
    pub fn default_embedded() -> Self {
        SeedsConfig {
            testnet: NetworkConfig {
                ...
                seeds: vec![
                    SeedNode {
                        ...
                        address: "seed-01.lichen.network:7001".to_string(),
                        pubkey: String::new(),
                    ...
                    SeedNode {
                        ...
                        address: "seed-02.lichen.network:7001".to_string(),
                        pubkey: String::new(),
                    ...
                    SeedNode {
                        ...
                        address: "seed-03.lichen.network:7001".to_string(),
                        pubkey: String::new(),
                    ...
                    SeedNode {
                        ...
                        address: "seed-04.lichen.network:7001".to_string(),
                        pubkey: String::new(),
            ...
            mainnet: NetworkConfig {
                network_id: "lichen-mainnet-1".to_string(),
                chain_id: "lichen-mainnet-1".to_string(),
                seeds: vec![
                    SeedNode {
                        id: "seed-01".to_string(),
                        address: "seed-01.lichen.network:8001".to_string(),
                        pubkey: String::new(),
                        region: "us-east".to_string(),
                        operator: "Lichen Foundation".to_string(),
                        rpc: "https://rpc.lichen.network".to_string(),
                    },
                    SeedNode {
                        id: "seed-02".to_string(),
                        address: "seed-02.lichen.network:8001".to_string(),
                        pubkey: String::new(),
                        region: "eu-west".to_string(),
                        operator: "Lichen Foundation".to_string(),
                        rpc: "https://rpc.lichen.network".to_string(),
                    ...
                    SeedNode {
                        id: "seed-03".to_string(),
                        address: "seed-03.lichen.network:8001".to_string(),
                        pubkey: String::new(),
                        region: "ap-southeast".to_string(),
                        operator: "Lichen Foundation".to_string(),
                        rpc: "https://rpc.lichen.network".to_string(),
                    ...
                    SeedNode {
                        id: "seed-04".to_string(),
                        address: "seed-04.lichen.network:8001".to_string(),
                        pubkey: String::new(),
                        region: "india".to_string(),
                        operator: "Lichen Foundation".to_string(),
                        rpc: "https://rpc.lichen.network".to_string(),
                ...
                bootstrap_peers: vec![
                    "seed-01.lichen.network:8001".to_string(),
                    "seed-02.lichen.network:8001".to_string(),
                    "seed-03.lichen.network:8001".to_string(),
                    "seed-04.lichen.network:8001".to_string(),
                ],
                rpc_endpoints: vec!["https://rpc.lichen.network".to_string()],
                explorers: vec!["https://explorer.lichen.network".to_string()],
                faucets: vec![],
            },
            devnet: NetworkConfig {
                network_id: "lichen-devnet-1".to_string(),
                chain_id: "lichen-devnet-1".to_string(),
                seeds: vec![],
