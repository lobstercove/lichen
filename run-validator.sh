...
if [[ -z "${LICHEN_SIGNED_METADATA_KEYPAIR_FILE:-}" ]]; then
	if [[ -n "${SIGNED_METADATA_KEYPAIR:-}" ]]; then
		export LICHEN_SIGNED_METADATA_KEYPAIR_FILE="$SIGNED_METADATA_KEYPAIR"
	elif [[ -f "$SIGNED_METADATA_KEYPAIR_FILE_DEFAULT" ]]; then
		export LICHEN_SIGNED_METADATA_KEYPAIR_FILE="$SIGNED_METADATA_KEYPAIR_FILE_DEFAULT"
	fi
fi
