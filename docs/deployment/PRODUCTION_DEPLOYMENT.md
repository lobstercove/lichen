...
The target testnet release for this runbook is `v0.5.267`; the current signed
...
four-validator Archive V2 gate pass. Once the fleet is proven on `v0.5.267`,
...
```bash
LICHEN_RELEASE_TAG=v0.5.267 LICHEN_COORDINATED_RELEASE=1 \
