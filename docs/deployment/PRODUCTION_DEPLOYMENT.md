...
Current testnet release candidate for this runbook is `v0.5.233`; keep signed
...
The `v0.5.229` anchor cannot be used after any required legacy rows are retired.
