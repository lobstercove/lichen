...
assert(
  productionDeployment.includes('Current signed-release target for this runbook is `v0.5.185`') &&
    productionDeployment.includes('keep `v0.5.183` as the signed rollback point') &&
    ...
    productionDeployment.includes('export LICHEN_RELEASE_TAG=v0.5.185') &&
  ...
  'production clean-slate checklist must match current v0.5.185 rollback v0.5.183/32-symbol/13-market expectations',
);
assert(
