...
assert(
  productionDeployment.includes('Current signed-release target for this runbook is `v0.5.138`') &&
    ...
    productionDeployment.includes('export LICHEN_RELEASE_TAG=v0.5.138') &&
  ...
  'production clean-slate checklist must match current v0.5.138/32-symbol/13-market expectations',
);
