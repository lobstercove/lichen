...
assert(
  productionDeployment.includes('Current signed-release target for this runbook is `v0.5.181`') &&
    ...
    productionDeployment.includes('export LICHEN_RELEASE_TAG=v0.5.181') &&
  ...
  'production clean-slate checklist must match current v0.5.181 rollback v0.5.179/32-symbol/13-market expectations',
);
assert(
