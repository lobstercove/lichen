...
assert(
  productionDeployment.includes('Current signed-release target for this runbook is `v0.5.175`') &&
    ...
    productionDeployment.includes('export LICHEN_RELEASE_TAG=v0.5.175') &&
