...
assert(
  productionDeployment.includes('Current signed-release target for this runbook is `v0.5.179`') &&
    productionDeployment.includes('keep `v0.5.178` as the signed rollback point') &&
    ...
    productionDeployment.includes('export LICHEN_RELEASE_TAG=v0.5.179') &&
  ...
  'production clean-slate checklist must match current v0.5.179 rollback v0.5.178/32-symbol/13-market expectations',
);
assert(
