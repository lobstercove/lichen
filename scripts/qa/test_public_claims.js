...
const requiredText = [
    ...
    ['README.md', '**Candidate release line:** `v0.5.278`', 'README identifies the candidate source release line'],
    ...
    ['developers/cli-reference.html', 'Source-verified for release line <code>v0.5.278</code>', 'CLI reference identifies the source release line'],
    ...
    ['developers/getting-started.html', 'lichen 0.5.278', 'getting-started guide matches the source release line'],
    ['developers/changelog.html', '<span class="changelog-version">v0.5.278</span>', 'developer changelog identifies the candidate release line'],
    ['docs/deployment/PRODUCTION_DEPLOYMENT.md', 'LICHEN_RELEASE_TAG=v0.5.278', 'production runbook uses the candidate release line'],
    ['deploy/mainnet-launch-runbook.md', 'export LICHEN_RELEASE_TAG=v0.5.278', 'launch runbook uses the candidate release line'],
    ['docs/deployment/ARCHIVE_V2_ACTIVATION_CADENCE_AND_VALIDATOR_LIVENESS_PLAN_2026-08-18.md', '`v0.5.278` is the only successor candidate', 'Archive V2 execution plan identifies the candidate release line'],
    ['developers/exchange-integration.html', 'exchange-testnet-v0.5.278', 'exchange portal identifies the candidate package line'],
