...
const requiredText = [
    ...
    ['README.md', '**Candidate release line:** `v0.5.266`', 'README identifies the candidate source release line'],
    ...
    ['developers/cli-reference.html', 'Source-verified for release line <code>v0.5.266</code>', 'CLI reference identifies the source release line'],
    ...
    ['developers/getting-started.html', 'lichen 0.5.266', 'getting-started guide matches the source release line'],
