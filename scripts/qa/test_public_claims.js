...
const requiredText = [
    ...
    ['README.md', `**Candidate release line:** \`v${runtimeVersion}\``, 'README identifies the candidate source release line'],
    ...
    ['docs/deployment/ARCHIVE_V2_ACTIVATION_CADENCE_AND_VALIDATOR_LIVENESS_PLAN_2026-08-18.md', `\`v${runtimeVersion}\` is the only successor candidate`, 'Archive V2 execution plan identifies the candidate release line'],
