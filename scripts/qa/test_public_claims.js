...
const requiredText = [
    ...
    ['README.md', '`v0.5.265`\ncandidate becomes an installable release only when', 'README separates candidate qualification from release'],
    ...
    ['developers/cli-reference.html', 'Source-verified for candidate <code>v0.5.265</code>', 'CLI reference identifies the current source candidate'],
