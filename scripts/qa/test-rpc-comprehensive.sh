...
if command -v node >/dev/null 2>&1 && [ -f "$ROOT_DIR/scripts/qa/e2e-rpc-coverage.js" ] && [ -f "$ROOT_DIR/scripts/qa/helpers/funded-wallets.js" ]; then
...
echo "🧪 Lichen RPC Comprehensive Test" > $RESULTS_FILE
...
test_rpc "getMossStakePoolInfo" "getMossStakePoolInfo" "[]"
