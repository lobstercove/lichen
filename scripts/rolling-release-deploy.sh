...
is_consensus_critical_release() {
  ...
  case "$RELEASE_TAG" in
    v0.5.188|v0.5.223|v0.5.224|v0.5.225|v0.5.226|v0.5.227|v0.5.228|v0.5.229|v0.5.230|v0.5.231|v0.5.232|v0.5.233|v0.5.234|v0.5.235|v0.5.236|v0.5.237|v0.5.238|v0.5.239|v0.5.240) return 0 ;;
  esac
...
sudo -n -u lichen /usr/local/bin/lichen-validator "${repair_args[@]}" \
  --confirm repair-dex-contracts:testnet:v0.5.274
