...
#
# Usage:
#   LICHEN_RELEASE_TAG=v0.5.180 bash scripts/rolling-release-deploy.sh testnet
#   LICHEN_RELEASE_TAG=v0.5.180 bash scripts/rolling-release-deploy.sh mainnet
#   LICHEN_RELEASE_TAG=v0.5.180 LICHEN_VERIFY_RELEASE_ONLY=1 bash scripts/rolling-release-deploy.sh testnet
#
