...
# ── 6. Validator joiner state policy ──
echo ""
echo -e "${CYAN}──────────────────────────────────────────────────────${NC}"
echo -e "${CYAN}  Validator joiner state policy${NC}"
echo -e "${CYAN}──────────────────────────────────────────────────────${NC}"
echo ""
echo -e "  ${GREEN}✓${NC} Not distributing genesis-wallet.json or genesis-keys/."
echo "  Joining validators start from their own keypair plus seeds.json and sync from peers."
