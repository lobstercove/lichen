 ...
 *  C22.1 — lichenpunks bare panic!() replaced with error message
...
// ═══════════════════════════════════════════════════════════════════════════
// C22.1 — lichenpunks bare panic!() replaced with descriptive message
// ═══════════════════════════════════════════════════════════════════════════
console.log('\n── C22.1: lichenpunks panic message ──');
{
    const src = fs.readFileSync(path.join(ROOT, 'contracts', 'lichenpunks', 'src', 'lib.rs'), 'utf8');
