...
BASE="${LICHEN_RPC_URL:-http://localhost:8899}/api/v1"
PASS=0
FAIL=0
SKIP=0
...
check_json "pairs[0] symbol=LICN/lUSD" "$BASE/pairs" "d['data'][0]['symbol']" "LICN/lUSD"
check_json "pairs[0] baseSymbol=LICN" "$BASE/pairs" "d['data'][0]['baseSymbol']" "LICN"
check_json "pairs[0] quoteSymbol=lUSD" "$BASE/pairs" "d['data'][0]['quoteSymbol']" "lUSD"
...
check_json "pair1=LICN/lUSD" "$BASE/pairs" "d['data'][0]['symbol']" "LICN/lUSD"
check_json "pair2=wSOL/lUSD" "$BASE/pairs" "d['data'][1]['symbol']" "wSOL/lUSD"
check_json "pair3=wETH/lUSD" "$BASE/pairs" "d['data'][2]['symbol']" "wETH/lUSD"
check_json "pair4=wSOL/LICN" "$BASE/pairs" "d['data'][3]['symbol']" "wSOL/LICN"
check_json "pair5=wETH/LICN" "$BASE/pairs" "d['data'][4]['symbol']" "wETH/LICN"

# ─── 4. GET /pairs/:id — single pair ───
echo "── 4. Single Pair ──"
check_json "pair/1 symbol=LICN/lUSD" "$BASE/pairs/1" "d['data']['symbol']" "LICN/lUSD"
check_json "pair/1 baseSymbol=LICN" "$BASE/pairs/1" "d['data']['baseSymbol']" "LICN"
check_json "pair/1 quoteSymbol=lUSD" "$BASE/pairs/1" "d['data']['quoteSymbol']" "lUSD"
check_json "pair/5 symbol=wETH/LICN" "$BASE/pairs/5" "d['data']['symbol']" "wETH/LICN"
...
check_json "pool[0] tokenASymbol=LICN" "$BASE/pools" "d['data'][0]['tokenASymbol']" "LICN"
check_json "pool[0] tokenBSymbol=lUSD" "$BASE/pools" "d['data'][0]['tokenBSymbol']" "lUSD"
...
check_json "pool1=LICN/lUSD" "$BASE/pools" "f\"{d['data'][0]['tokenASymbol']}/{d['data'][0]['tokenBSymbol']}\"" "LICN/lUSD"
check_json "pool5=wETH/LICN" "$BASE/pools" "f\"{d['data'][4]['tokenASymbol']}/{d['data'][4]['tokenBSymbol']}\"" "wETH/LICN"
...
check_status "stats/lichenswap responds" "$BASE/stats/lichenswap"
...
check_json "pair/2 quoteSymbol=lUSD" "$BASE/pairs/2" "d['data']['quoteSymbol']" "lUSD"
...
check_json "pair/4 quoteSymbol=LICN" "$BASE/pairs/4" "d['data']['quoteSymbol']" "LICN"
