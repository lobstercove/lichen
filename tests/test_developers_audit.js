...
const SHOULD_NOT_HAVE_INLINE_STYLE = [
    ...
    'validator.html', 'cli-reference.html', 'lichenid.html',
...
// Canonical tier names from contracts/lichenid/src/lib.rs
...
// ------------------------------------------------------------------
// D4: Copy buttons on contracts.html and lichenid.html
// ------------------------------------------------------------------
console.log('[D4] Copy buttons on code blocks');

const contractsHtml = read('contracts.html');
const lichenidHtml   = read('lichenid.html');
const contractsCopyCount = (contractsHtml.match(/code-copy-btn/g) || []).length;
const lichenidCopyCount   = (lichenidHtml.match(/code-copy-btn/g) || []).length;
ok(contractsCopyCount >= 12, `contracts.html has ${contractsCopyCount} copy buttons (>= 12)`);
ok(lichenidCopyCount >= 14, `lichenid.html has ${lichenidCopyCount} copy buttons (>= 14)`);
...
const SIDEBAR_PAGES = [
    'getting-started.html', 'contracts.html', 'architecture.html',
    'validator.html', 'cli-reference.html', 'lichenid.html', 'playground.html'
];
...
const BREADCRUMB_PAGES = [
    ...
    'lichenid.html', 'validator.html', 'changelog.html',
