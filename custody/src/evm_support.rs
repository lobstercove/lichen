...
pub(super) use self::rpc::{
    evm_estimate_gas, evm_get_balance, evm_get_block_number, evm_get_chain_id,
    evm_get_erc20_balance, evm_get_gas_price, evm_get_transaction_count,
    evm_get_transaction_receipt, evm_get_transfer_logs, evm_rpc_call,
};
