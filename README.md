...
**Current release:** signed `v0.5.40` with no-flush Neo rolling-upgrade compatibility, stale-peer bootstrap recovery, deterministic live commit replay, deterministic fee-burn accounting, and DEX oracle/candle regression coverage.
...
Examples:
- `https://github.com/lobstercove/lichen/releases/download/v0.5.40/lichen-validator-linux-x86_64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.40/lichen-validator-darwin-aarch64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.40/lichen-validator-windows-x86_64.tar.gz`
