...
**Current release:** signed `v0.5.35`, deployed on the public testnet with deterministic live commit replay, deterministic post-block fee accounting, DEX partial-fill escrow preservation, and non-destructive rolling release deployment.
...
Examples:
- `https://github.com/lobstercove/lichen/releases/download/v0.5.35/lichen-validator-linux-x86_64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.35/lichen-validator-darwin-aarch64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.35/lichen-validator-windows-x86_64.tar.gz`
