...
**Current release:** signed `v0.5.94` with first-class BTC/wBTC support: future-genesis WBTC, additive live-testnet WBTC activation, Bitcoin Core-backed custody deposit/sweep/withdrawal support, wBTC DEX pairs and oracle feeds, wallet/extension/DEX/developer-surface BTC routing, and the v0.5.93 stable validator base without replaying historical state.
...
Examples:
- `https://github.com/lobstercove/lichen/releases/download/v0.5.94/lichen-validator-linux-x86_64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.94/lichen-validator-darwin-aarch64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.94/lichen-validator-windows-x86_64.tar.gz`
