...
**Current release:** signed `v0.5.31`, deployed on the public testnet with deterministic live commit replay and non-destructive rolling release deployment.
...
Examples:
- `https://github.com/lobstercove/lichen/releases/download/v0.5.31/lichen-validator-linux-x86_64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.31/lichen-validator-darwin-aarch64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.31/lichen-validator-windows-x86_64.tar.gz`
