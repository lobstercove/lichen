...
**Current testnet release:** `v0.5.225`. The signed rollback anchor is `v0.5.224`. This release retains the July liveness and hot/cold archive guarantees while adding hard-link-aware checkpoint pressure recovery so derived snapshots cannot pin obsolete SSTs until a validator reaches its runtime safety exit. The existing testnet has an explicit legacy-history waiver; fresh networks and mainnet fail closed on incomplete genesis-to-tip history.
...
Examples:
- `https://github.com/lobstercove/lichen/releases/download/v0.5.225/lichen-validator-linux-x86_64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.225/lichen-validator-darwin-aarch64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.225/lichen-validator-windows-x86_64.tar.gz`
