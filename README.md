...
**Current release:** signed `v0.5.36`, deployed on the public testnet with deterministic live commit replay, deterministic post-block fee accounting, DEX partial-fill escrow preservation, and fresh-genesis prediction market dependency wiring.
...
Examples:
- `https://github.com/lobstercove/lichen/releases/download/v0.5.36/lichen-validator-linux-x86_64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.36/lichen-validator-darwin-aarch64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.36/lichen-validator-windows-x86_64.tar.gz`
