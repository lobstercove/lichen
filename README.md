...
**Current release:** signed `v0.5.22`, deployed on the public testnet with independent validator genesis sync.
...
Examples:
- `https://github.com/lobstercove/lichen/releases/download/v0.5.22/lichen-validator-linux-x86_64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.22/lichen-validator-darwin-aarch64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.22/lichen-validator-windows-x86_64.tar.gz`
