...
**Current release:** signed `v0.5.46` with the clean Neo/GAS route, wNEO/wGAS contracts, Neo GAS rewards vault, reserve/liability proof services, agent/compute policy gates, wallet/DEX/RPC/SDK surfaces, DEX chart precision for Neo pairs, independent validator joiner P2P admission, and fail-closed public activation gates built on the stable `v0.5.37` base.
...
Examples:
- `https://github.com/lobstercove/lichen/releases/download/v0.5.46/lichen-validator-linux-x86_64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.46/lichen-validator-darwin-aarch64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.46/lichen-validator-windows-x86_64.tar.gz`
