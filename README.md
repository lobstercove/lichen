...
**Current release:** signed `v0.5.103` with first-class BTC/wBTC support, slot-only MossStake state, deterministic legacy testnet bootstrap-grant replay, no startup historical StakePool repair scanner, local three-validator first-start sync validation, and the v0.5.93 stable validator base without replaying historical state.
...
Examples:
- `https://github.com/lobstercove/lichen/releases/download/v0.5.103/lichen-validator-linux-x86_64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.103/lichen-validator-darwin-aarch64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.103/lichen-validator-windows-x86_64.tar.gz`
