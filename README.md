...
Examples:
- `https://github.com/lobstercove/lichen/releases/download/v0.5.81/lichen-validator-linux-x86_64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.81/lichen-validator-darwin-aarch64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.81/lichen-validator-windows-x86_64.tar.gz`
