...
**Current release:** signed `v0.5.37`, deployed on the public testnet with deterministic live commit replay, deterministic fee-burn accounting in speculative block commits, DEX partial-fill escrow preservation, and fresh-genesis prediction market dependency wiring.
...
Examples:
- `https://github.com/lobstercove/lichen/releases/download/v0.5.37/lichen-validator-linux-x86_64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.37/lichen-validator-darwin-aarch64.tar.gz`
- `https://github.com/lobstercove/lichen/releases/download/v0.5.37/lichen-validator-windows-x86_64.tar.gz`
